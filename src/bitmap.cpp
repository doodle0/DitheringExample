...
const Bitmap::bitmap_t &Bitmap::GetMap() const { return map; }

void Bitmap::Set(int y, int x, uint8_t v) { map[y][x] = {v, v, v}; }

Bitmap::bitmap_row_t &Bitmap::operator[](size_t idx) { return map[idx]; }
